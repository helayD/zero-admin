...
class ProductDetailData {
  ...
  factory ProductDetailData.fromJson(Map<String, dynamic> json) =>
      ProductDetailData(
        ...
        productAttributeList: List<ProductAttributeList>.from(
            json["productAttributeList"]
                .map((x) => ProductAttributeList.fromJson(x))),
        productAttributeValueList: List<ProductAttributeValueList>.from(
            json["productAttributeValueList"]
                .map((x) => ProductAttributeValueList.fromJson(x))),
        skuStockList: List<SkuStockList>.from(
            json["skuStockList"].map((x) => SkuStockList.fromJson(x))),
        productLadderList: List<ProductLadderList>.from(
            json["productLadderList"]
                .map((x) => ProductLadderList.fromJson(x))),
        productFullReductionList: List<ProductFullReductionList>.from(
            json["productFullReductionList"]
                .map((x) => ProductFullReductionList.fromJson(x))),
        memberPriceList: List<MemberPriceList>.from(
            json["memberPriceList"].map((x) => MemberPriceList.fromJson(x))),
        couponList: List<CouponList>.from(
            json["couponList"].map((x) => CouponList.fromJson(x))),
        visibility: ProductVisibility.fromJson(json["visibility"] ?? {}),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "productAttributeList":
            List<dynamic>.from(productAttributeList.map((x) => x.toJson())),
        "productAttributeValueList": List<dynamic>.from(
            productAttributeValueList.map((x) => x.toJson())),
        "skuStockList": List<dynamic>.from(skuStockList.map((x) => x.toJson())),
        "productLadderList":
            List<dynamic>.from(productLadderList.map((x) => x.toJson())),
        "productFullReductionList":
            List<dynamic>.from(productFullReductionList.map((x) => x.toJson())),
        "memberPriceList":
            List<dynamic>.from(memberPriceList.map((x) => x.toJson())),
...
class ProductVisibility {
  ...
  factory ProductVisibility.fromJson(Map<String, dynamic> json) =>
      ProductVisibility(
        ...
        fallbackTarget: json["fallbackTarget"] ?? "",
      );
...
class MemberPriceList {
  ...
  factory MemberPriceList.fromJson(Map<String, dynamic> json) =>
      MemberPriceList(
        id: json["id"],
...
class ProductFullReductionList {
  ...
  factory ProductFullReductionList.fromJson(Map<String, dynamic> json) =>
      ProductFullReductionList(
        id: json["id"],
        productId: json["productId"],
...
class ProductLadderList {
  ...
  factory ProductLadderList.fromJson(Map<String, dynamic> json) =>
      ProductLadderList(
        id: json["id"],
        productId: json["productId"],
        count: json["count"],
