...
Run the BMAD command defined in `.claude/commands/bmad-gds-quick-spec.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-gds-quick-spec.md`.
