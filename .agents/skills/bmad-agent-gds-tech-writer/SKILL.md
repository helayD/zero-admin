...
Run the BMAD command defined in `.claude/commands/bmad-agent-gds-tech-writer.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-agent-gds-tech-writer.md`.
