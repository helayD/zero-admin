...
Run the BMAD command defined in `.claude/commands/bmad-bmb-create-module-brief.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-bmb-create-module-brief.md`.
