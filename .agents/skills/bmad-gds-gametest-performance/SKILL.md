...
# bmad-gds-gametest-performance

Run the BMAD command defined in `.claude/commands/bmad-gds-gametest-performance.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-gds-gametest-performance.md`.
