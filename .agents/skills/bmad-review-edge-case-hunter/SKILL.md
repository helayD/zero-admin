...
Run the BMAD command defined in `.claude/commands/bmad-review-edge-case-hunter.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-review-edge-case-hunter.md`.
