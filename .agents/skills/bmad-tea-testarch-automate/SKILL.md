...
Run the BMAD command defined in `.claude/commands/bmad-tea-testarch-automate.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-tea-testarch-automate.md`.
