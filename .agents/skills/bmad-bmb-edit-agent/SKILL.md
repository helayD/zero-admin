...
Run the BMAD command defined in `.claude/commands/bmad-bmb-edit-agent.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-bmb-edit-agent.md`.
