...
Run the BMAD command defined in `.claude/commands/bmad-agent-cis-design-thinking-coach.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-agent-cis-design-thinking-coach.md`.
