...
Run the BMAD command defined in `.claude/commands/bmad-bmm-create-epics-and-stories.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-bmm-create-epics-and-stories.md`.
