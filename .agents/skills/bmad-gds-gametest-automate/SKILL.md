...
Run the BMAD command defined in `.claude/commands/bmad-gds-gametest-automate.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-gds-gametest-automate.md`.
