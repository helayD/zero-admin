...
Run the BMAD command defined in `.claude/commands/bmad-agent-bmm-analyst.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-agent-bmm-analyst.md`.
