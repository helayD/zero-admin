...
Run the BMAD command defined in `.claude/commands/bmad-tea-teach-me-testing.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-tea-teach-me-testing.md`.
