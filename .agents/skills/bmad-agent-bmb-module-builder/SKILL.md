...
Run the BMAD command defined in `.claude/commands/bmad-agent-bmb-module-builder.md`, but do not stop at the command shim.

1. Load `.claude/commands/bmad-agent-bmb-module-builder.md`.
