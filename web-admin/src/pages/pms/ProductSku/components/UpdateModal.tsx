...
const UpdateModal: React.FC<UpdateModalProps> = (props) => {
    ...
    return (
      <>
        ...
        <FormItem
          name="albumPics"
          label="图片集"
          rules={[{ required: true, message: '请上传图片集!' }]}
        >
        ...
        <FormItem
          ...
          rules={[
            { required: true, message: '请输入审核状态：0-未审核，1-审核通过，2-审核不通过!' },
          ]}
        >
          <Radio.Group>
            <Radio value={0}>禁用</Radio>
        ...
        <FormItem name="sales" label="销量" rules={[{ required: true, message: '请输入销量!' }]}>
  ...
  return (
    <Modal forceRender destroyOnClose title="编辑" visible={updateVisible} {...modalFooter}>
