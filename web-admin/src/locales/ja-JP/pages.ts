export default {
  ...
  'pages.login.accountLogin.errorMessage': 'アカウントまたはパスワードが正しくありません',
  'pages.login.username.placeholder': 'ユーザー名または携帯番号',
  'pages.login.username.required': 'ユーザー名を入力してください！',
  'pages.login.password.placeholder': 'ログインパスワード',
  ...
  'pages.login.forgotPassword': 'パスワード再設定は管理者にお問い合わせください',
  'pages.login.submit': 'コンソールへ',
