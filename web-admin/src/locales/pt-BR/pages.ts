export default {
  ...
  'pages.login.accountLogin.errorMessage': 'Conta ou senha incorreta',
  'pages.login.username.placeholder': 'Usuário ou telefone',
  ...
  'pages.login.forgotPassword': 'Esqueceu a senha? Contate o administrador',
  'pages.login.submit': 'Entrar no painel',
