export default {
  ...
  'pages.login.accountLogin.errorMessage': 'Akun atau kata sandi salah',
  'pages.login.username.placeholder': 'Nama pengguna atau nomor ponsel',
  ...
  'pages.login.forgotPassword': 'Lupa kata sandi? Hubungi administrator',
  'pages.login.submit': 'Masuk ke konsol',
