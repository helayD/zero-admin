export default {
  ...
  'pages.login.accountLogin.errorMessage': 'حساب کاربری یا رمز عبور نادرست است',
  'pages.login.username.placeholder': 'نام کاربری یا شماره موبایل',
  ...
  'pages.login.forgotPassword': 'برای بازنشانی رمز عبور با مدیر سیستم تماس بگیرید',
  'pages.login.submit': 'ورود به کنسول',
