export default {
  ...
  'pages.login.accountLogin.errorMessage': 'অ্যাকাউন্ট বা পাসওয়ার্ড ভুল',
  'pages.login.failure': 'লগইন ব্যর্থ হয়েছে। আবার চেষ্টা করুন!',
  'pages.login.success': 'সফল লগইন!',
  'pages.login.username.placeholder': 'ব্যবহারকারীর নাম বা মোবাইল নম্বর',
  'pages.login.username.required': 'আপনার ব্যবহারকারীর নাম ইনপুট করুন!',
  'pages.login.password.placeholder': 'লগইন পাসওয়ার্ড',
  ...
  'pages.login.forgotPassword': 'পাসওয়ার্ড ভুলে গেলে প্রশাসকের সাথে যোগাযোগ করুন',
  'pages.login.submit': 'কনসোলে প্রবেশ করুন',
