...
VALUES
    (
        ...
        '完成实名后可参与春季限定抽卡，每次消耗 1 次抽卡次数，中奖后生成唯一数字卡片资产。',
        '2026-03-01 00:00:00', '2026-12-31 23:59:59', 1, '仅实名且已完成新手任务的会员可参与',
        ...
        '实名用户限时抽取春季数字卡片', 'https://img.example.com/digital-card/spring-entry.png', 100, 1,
