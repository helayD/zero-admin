...
ALTER TABLE pms_product_spu
    ADD COLUMN fulfillment_mode VARCHAR(32) DEFAULT 'physical_delivery' NOT NULL COMMENT '履约模式: physical_delivery-实物发货, digital_asset-数字资产',
...
ALTER TABLE pms_product_sku
    ADD COLUMN fulfillment_mode VARCHAR(32) DEFAULT NULL COMMENT '履约模式覆盖: physical_delivery-实物发货, digital_asset-数字资产; NULL表示继承SPU',
