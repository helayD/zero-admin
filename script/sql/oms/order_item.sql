...
create index idx_scope_order
    on oms_order_item (platform_id, tenant_id, merchant_id, order_id, sku_id);
...
(7, 'ORD20231206001', 1, 13, 'Apple iPhone 15 Pro', 'http://129.204.203.29/big.png',
 299.00, 1, '{"color": "Black", "storage": "256GB"}', 299.00, 0.00,
 0.00, 0.00, 0.00, 299.00, '2023-12-06 11:15:00.000'),

(7, 'ORD20231206001', 2, 14, 'iPhone Screen Protector', 'http://129.204.203.29/big.png',
