...
const (
	CardAssetService_EnsureCardInstanceByParticipationRecord_FullMethodName = "/smsclient.CardAssetService/EnsureCardInstanceByParticipationRecord"
	CardAssetService_QueryCardInstanceByParticipationRecord_FullMethodName  = "/smsclient.CardAssetService/QueryCardInstanceByParticipationRecord"
	CardAssetService_BackfillWinningCardInstances_FullMethodName            = "/smsclient.CardAssetService/BackfillWinningCardInstances"
)

// CardAssetServiceClient is the client API for CardAssetService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type CardAssetServiceClient interface {
...
type cardAssetServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewCardAssetServiceClient(cc grpc.ClientConnInterface) CardAssetServiceClient {
	return &cardAssetServiceClient{cc}
}

func (c *cardAssetServiceClient) EnsureCardInstanceByParticipationRecord(ctx context.Context, in *EnsureCardInstanceByParticipationRecordReq, opts ...grpc.CallOption) (*EnsureCardInstanceByParticipationRecordResp, error) {
	out := new(EnsureCardInstanceByParticipationRecordResp)
	err := c.cc.Invoke(ctx, CardAssetService_EnsureCardInstanceByParticipationRecord_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cardAssetServiceClient) QueryCardInstanceByParticipationRecord(ctx context.Context, in *QueryCardInstanceByParticipationRecordReq, opts ...grpc.CallOption) (*QueryCardInstanceByParticipationRecordResp, error) {
	out := new(QueryCardInstanceByParticipationRecordResp)
	err := c.cc.Invoke(ctx, CardAssetService_QueryCardInstanceByParticipationRecord_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cardAssetServiceClient) BackfillWinningCardInstances(ctx context.Context, in *BackfillWinningCardInstancesReq, opts ...grpc.CallOption) (*BackfillWinningCardInstancesResp, error) {
	out := new(BackfillWinningCardInstancesResp)
	err := c.cc.Invoke(ctx, CardAssetService_BackfillWinningCardInstances_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// CardAssetServiceServer is the server API for CardAssetService service.
// All implementations must embed UnimplementedCardAssetServiceServer
// for forward compatibility
type CardAssetServiceServer interface {
	EnsureCardInstanceByParticipationRecord(context.Context, *EnsureCardInstanceByParticipationRecordReq) (*EnsureCardInstanceByParticipationRecordResp, error)
	QueryCardInstanceByParticipationRecord(context.Context, *QueryCardInstanceByParticipationRecordReq) (*QueryCardInstanceByParticipationRecordResp, error)
	BackfillWinningCardInstances(context.Context, *BackfillWinningCardInstancesReq) (*BackfillWinningCardInstancesResp, error)
	mustEmbedUnimplementedCardAssetServiceServer()
}

// UnimplementedCardAssetServiceServer must be embedded to have forward compatible implementations.
type UnimplementedCardAssetServiceServer struct {
}

func (UnimplementedCardAssetServiceServer) EnsureCardInstanceByParticipationRecord(context.Context, *EnsureCardInstanceByParticipationRecordReq) (*EnsureCardInstanceByParticipationRecordResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnsureCardInstanceByParticipationRecord not implemented")
}
func (UnimplementedCardAssetServiceServer) QueryCardInstanceByParticipationRecord(context.Context, *QueryCardInstanceByParticipationRecordReq) (*QueryCardInstanceByParticipationRecordResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryCardInstanceByParticipationRecord not implemented")
}
func (UnimplementedCardAssetServiceServer) BackfillWinningCardInstances(context.Context, *BackfillWinningCardInstancesReq) (*BackfillWinningCardInstancesResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BackfillWinningCardInstances not implemented")
}
func (UnimplementedCardAssetServiceServer) mustEmbedUnimplementedCardAssetServiceServer() {}

// UnsafeCardAssetServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to CardAssetServiceServer will
// result in compilation errors.
type UnsafeCardAssetServiceServer interface {
	mustEmbedUnimplementedCardAssetServiceServer()
}

func RegisterCardAssetServiceServer(s grpc.ServiceRegistrar, srv CardAssetServiceServer) {
	s.RegisterService(&CardAssetService_ServiceDesc, srv)
}

func _CardAssetService_EnsureCardInstanceByParticipationRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnsureCardInstanceByParticipationRecordReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardAssetServiceServer).EnsureCardInstanceByParticipationRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardAssetService_EnsureCardInstanceByParticipationRecord_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardAssetServiceServer).EnsureCardInstanceByParticipationRecord(ctx, req.(*EnsureCardInstanceByParticipationRecordReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _CardAssetService_QueryCardInstanceByParticipationRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryCardInstanceByParticipationRecordReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardAssetServiceServer).QueryCardInstanceByParticipationRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardAssetService_QueryCardInstanceByParticipationRecord_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardAssetServiceServer).QueryCardInstanceByParticipationRecord(ctx, req.(*QueryCardInstanceByParticipationRecordReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _CardAssetService_BackfillWinningCardInstances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BackfillWinningCardInstancesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardAssetServiceServer).BackfillWinningCardInstances(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardAssetService_BackfillWinningCardInstances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardAssetServiceServer).BackfillWinningCardInstances(ctx, req.(*BackfillWinningCardInstancesReq))
	}
	return interceptor(ctx, in, info, handler)
}

// CardAssetService_ServiceDesc is the grpc.ServiceDesc for CardAssetService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var CardAssetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smsclient.CardAssetService",
	HandlerType: (*CardAssetServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "EnsureCardInstanceByParticipationRecord",
			Handler:    _CardAssetService_EnsureCardInstanceByParticipationRecord_Handler,
		},
		{
			MethodName: "QueryCardInstanceByParticipationRecord",
			Handler:    _CardAssetService_QueryCardInstanceByParticipationRecord_Handler,
		},
		{
			MethodName: "BackfillWinningCardInstances",
			Handler:    _CardAssetService_BackfillWinningCardInstances_Handler,
		},
	},
...
const (
	...
	CouponRecordService_QueryAvailableCoupons_FullMethodName   = "/smsclient.CouponRecordService/QueryAvailableCoupons"
)
...
func (c *couponRecordServiceClient) QueryAvailableCoupons(ctx context.Context, in *QueryAvailableCouponsReq, opts ...grpc.CallOption) (*QueryAvailableCouponsResp, error) {
	out := new(QueryAvailableCouponsResp)
	err := c.cc.Invoke(ctx, CouponRecordService_QueryAvailableCoupons_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCouponRecordServiceServer) QueryAvailableCoupons(context.Context, *QueryAvailableCouponsReq) (*QueryAvailableCouponsResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryAvailableCoupons not implemented")
}
...
func _CouponRecordService_QueryAvailableCoupons_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryAvailableCouponsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CouponRecordServiceServer).QueryAvailableCoupons(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CouponRecordService_QueryAvailableCoupons_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CouponRecordServiceServer).QueryAvailableCoupons(ctx, req.(*QueryAvailableCouponsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CouponRecordService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryAvailableCoupons",
			Handler:    _CouponRecordService_QueryAvailableCoupons_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc/sms/sms.proto",
