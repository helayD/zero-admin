...
type SmsHomeAdvertise struct {
	...
	ActivityType string     `gorm:"column:activity_type;not null;default:'';comment:活动类型" json:"activity_type"`            // 活动类型
	ActivityID   int64      `gorm:"column:activity_id;not null;default:0;comment:活动ID" json:"activity_id"`                 // 活动ID
