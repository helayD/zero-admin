...
func (l *QueryDrawActivityDetailLogic) QueryDrawActivityDetail(in *smsclient.QueryDrawActivityDetailReq) (*smsclient.QueryDrawActivityDetailResp, error) {
	...
	return &smsclient.QueryDrawActivityDetailResp{
		...
		ConsumeType:                 aggregate.Activity.ConsumeType,
		ConsumeAmount:               aggregate.Activity.ConsumeAmount,
		QuotaPerMember:              aggregate.Activity.QuotaPerMember,
		DailyQuotaPerMember:         aggregate.Activity.DailyQuotaPerMember,
