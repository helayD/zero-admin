...
package drawparticipationservice
...
type (
	...
	DrawParticipationService interface {
	...
	defaultDrawParticipationService struct {
		cli zrpc.Client
	}
)

func NewDrawParticipationService(cli zrpc.Client) DrawParticipationService {
	return &defaultDrawParticipationService{
		cli: cli,
	}
}

func (m *defaultDrawParticipationService) QueryDrawActivityLanding(ctx context.Context, in *QueryDrawActivityLandingReq, opts ...grpc.CallOption) (*QueryDrawActivityLandingResp, error) {
	client := smsclient.NewDrawParticipationServiceClient(m.cli.Conn())
	return client.QueryDrawActivityLanding(ctx, in, opts...)
}

func (m *defaultDrawParticipationService) PreviewDrawEligibility(ctx context.Context, in *PreviewDrawEligibilityReq, opts ...grpc.CallOption) (*PreviewDrawEligibilityResp, error) {
	client := smsclient.NewDrawParticipationServiceClient(m.cli.Conn())
	return client.PreviewDrawEligibility(ctx, in, opts...)
}

func (m *defaultDrawParticipationService) ParticipateDraw(ctx context.Context, in *ParticipateDrawReq, opts ...grpc.CallOption) (*ParticipateDrawResp, error) {
	client := smsclient.NewDrawParticipationServiceClient(m.cli.Conn())
	return client.ParticipateDraw(ctx, in, opts...)
}

func (m *defaultDrawParticipationService) QueryMemberDrawRecordList(ctx context.Context, in *QueryMemberDrawRecordListReq, opts ...grpc.CallOption) (*QueryMemberDrawRecordListResp, error) {
	client := smsclient.NewDrawParticipationServiceClient(m.cli.Conn())
	return client.QueryMemberDrawRecordList(ctx, in, opts...)
}
