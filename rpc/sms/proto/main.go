...
*/
func main() {
	folderPath := "rpc/sms/proto"         // 替换为你的文件夹路径
	outputFilePath := "rpc/sms/sms.proto" // 新文件的路径
	...
	start := strings.Replace(string(startContents), "package main", "package smsclient", 1)
	start = strings.Replace(start, "option go_package = \"./proto\"", "option go_package = \"./smsclient\"", 1)
