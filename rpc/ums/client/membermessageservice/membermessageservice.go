...
type (
	...
	defaultMemberMessageService struct {
		cli zrpc.Client
	}
)

func NewMemberMessageService(cli zrpc.Client) MemberMessageService {
	return &defaultMemberMessageService{
		cli: cli,
	}
}
