...
type (
	...
	MemberIdentityService interface {
	...
	defaultMemberIdentityService struct {
		cli zrpc.Client
	}
)

func NewMemberIdentityService(cli zrpc.Client) MemberIdentityService {
	return &defaultMemberIdentityService{
		cli: cli,
	}
}

func (m *defaultMemberIdentityService) QueryMemberIdentityProfile(ctx context.Context, in *QueryMemberIdentityProfileReq, opts ...grpc.CallOption) (*QueryMemberIdentityProfileResp, error) {
	client := umsclient.NewMemberIdentityServiceClient(m.cli.Conn())
	return client.QueryMemberIdentityProfile(ctx, in, opts...)
}
