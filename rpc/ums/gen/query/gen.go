...
var (
	...
	UmsMemberMessage         *umsMemberMessage
...
func SetDefault(db *gorm.DB, opts ...gen.DOOption) {
	*Q = *Use(db, opts...)
	...
	UmsMemberMessage = &Q.UmsMemberMessage
...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		UmsMemberMessage:        newUmsMemberMessage(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		UmsMemberMessage:        q.UmsMemberMessage.clone(db),
...
type queryCtx struct {
	...
	UmsMemberMessage        IUmsMemberMessageDo
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		UmsMemberMessage:        q.UmsMemberMessage.WithContext(ctx),
