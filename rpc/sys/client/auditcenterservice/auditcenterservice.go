...
type (
	...
	defaultAuditCenterService struct {
		cli zrpc.Client
	}
)

func NewAuditCenterService(cli zrpc.Client) AuditCenterService {
	return &defaultAuditCenterService{
		cli: cli,
	}
}

func (m *defaultAuditCenterService) QueryAuditCenterList(ctx context.Context, in *QueryAuditCenterListReq, opts ...grpc.CallOption) (*QueryAuditCenterListResp, error) {
	client := sysclient.NewAuditCenterServiceClient(m.cli.Conn())
	return client.QueryAuditCenterList(ctx, in, opts...)
}

func (m *defaultAuditCenterService) QueryAuditCenterDetail(ctx context.Context, in *QueryAuditCenterDetailReq, opts ...grpc.CallOption) (*QueryAuditCenterDetailResp, error) {
	client := sysclient.NewAuditCenterServiceClient(m.cli.Conn())
	return client.QueryAuditCenterDetail(ctx, in, opts...)
}
