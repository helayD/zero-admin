...
func (m *defaultMerchantService) CreateMerchant(ctx context.Context, in *CreateMerchantReq, opts ...grpc.CallOption) (*CreateMerchantResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.CreateMerchant(ctx, in, opts...)
}

func (m *defaultMerchantService) QueryMerchantDetail(ctx context.Context, in *QueryMerchantDetailReq, opts ...grpc.CallOption) (*QueryMerchantDetailResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.QueryMerchantDetail(ctx, in, opts...)
}

func (m *defaultMerchantService) QueryMerchantList(ctx context.Context, in *QueryMerchantListReq, opts ...grpc.CallOption) (*QueryMerchantListResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.QueryMerchantList(ctx, in, opts...)
}

func (m *defaultMerchantService) ApproveMerchant(ctx context.Context, in *ReviewMerchantReq, opts ...grpc.CallOption) (*ReviewMerchantResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.ApproveMerchant(ctx, in, opts...)
}

func (m *defaultMerchantService) RejectMerchant(ctx context.Context, in *ReviewMerchantReq, opts ...grpc.CallOption) (*ReviewMerchantResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.RejectMerchant(ctx, in, opts...)
}

func (m *defaultMerchantService) RequestMerchantMaterial(ctx context.Context, in *ReviewMerchantReq, opts ...grpc.CallOption) (*ReviewMerchantResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.RequestMerchantMaterial(ctx, in, opts...)
}

func (m *defaultMerchantService) EnableMerchant(ctx context.Context, in *ChangeMerchantStatusReq, opts ...grpc.CallOption) (*ChangeMerchantStatusResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.EnableMerchant(ctx, in, opts...)
}

func (m *defaultMerchantService) DisableMerchant(ctx context.Context, in *ChangeMerchantStatusReq, opts ...grpc.CallOption) (*ChangeMerchantStatusResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.DisableMerchant(ctx, in, opts...)
}

func (m *defaultMerchantService) ArchiveMerchant(ctx context.Context, in *ChangeMerchantStatusReq, opts ...grpc.CallOption) (*ChangeMerchantStatusResp, error) {
	client := sysclient.NewMerchantServiceClient(m.cli.Conn())
	return client.ArchiveMerchant(ctx, in, opts...)
}
