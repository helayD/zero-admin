...
type DrawPoolTemplateData struct {
	...
	Rarity         string  `json:"rarity,optional"`       // 稀有度
	SlotIndex      int32   `json:"slotIndex,optional"`    // 转盘格位 (1-5)
...
type QueryCouponRecordListData struct {
	Id             int64   `json:"id"`             //
	CouponId       int64   `json:"couponId"`       //优惠券ID
	CouponCode     string  `json:"couponCode"`     //优惠券码（从 sms_coupon 拼装）
	MemberId       int64   `json:"memberId"`       //用户ID
	MemberNickName string  `json:"memberNickName"` //领取会员昵称（脱敏，从 ums_member 拼装）
