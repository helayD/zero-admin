...
func (l *AddDrawActivityLogic) AddDrawActivity(req *types.AddDrawActivityReq) (*types.BaseResp, error) {
	...
	_, err = l.svcCtx.DrawActivityService.AddDrawActivity(l.ctx, &smsclient.AddDrawActivityReq{
		...
		QuotaPerMember:              req.QuotaPerMember,
		DailyQuotaPerMember:         req.DailyQuotaPerMember,
	...
	return &types.BaseResp{Code: "000000", Message: "新增抽卡活动成功"}, nil
}
