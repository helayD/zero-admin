...
// QueryOrderMainDetailLogic 查询订单详情
/*
Author: LiuFeiHua
Date: 2025/07/01 10:06:43
*/
type QueryOrderMainDetailLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewQueryOrderMainDetailLogic(ctx context.Context, svcCtx *svc.ServiceContext) *QueryOrderMainDetailLogic {
	return &QueryOrderMainDetailLogic{
